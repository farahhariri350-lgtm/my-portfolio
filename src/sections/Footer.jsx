  ...
  return (
    <footer className="footer-section">
      ...
      <div className="footer-container">
        ...
        {/* السطر 1: روابط التنقل (Home, About me, Contact) */}
        ...
        {/* السطر 2: أيقونات السوشيال ميديا الدائرية */}
        <div className="frame-28-socials">
          <a href="https://facebook.com" target="_blank" rel="noreferrer">
            <img src={Frame25} alt="Facebook" className="circle-social-icon" />
          </a>
          <a href="https://instagram.com" target="_blank" rel="noreferrer">
            <img src={Frame27} alt="Instagram" className="circle-social-icon" />
          </a>
          <a href="https://twitter.com" target="_blank" rel="noreferrer">
            <img src={Frame26} alt="Twitter" className="circle-social-icon" />
          </a>
          <a href="https://youtube.com" target="_blank" rel="noreferrer">
            <img src={Frame24} alt="YouTube" className="circle-social-icon" />
          </a>
        </div>

        {/* السطر 3: نصوص السياسة (أقصى اليمين) */}
